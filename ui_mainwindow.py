...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionProfundidad.setText(QCoreApplication.translate("MainWindow", u"Recorrido en Profundidad", None))
        self.actionAmplitud.setText(QCoreApplication.translate("MainWindow", u"Recorrido en Amplitud", None))
